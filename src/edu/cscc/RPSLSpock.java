...
/**
 * @author Austin Grubb
 * deals with win handling, pick validation, and generating pick.
 * 2/25/2020
 */
public class RPSLSpock {
    ...
    /**
     * checks if pick is valid then return boolean
     * @param pick user's choice
     * @return if pick is valid
     */
    ...
    /**
     * randomly picks a value for computer.
     * @return pick- the computer generated pick
     */
